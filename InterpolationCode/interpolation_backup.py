...
for i in range(0,501):
    filename = '/home/dg321/gitTest/PRI/irp/Flow_Data/Flow_past_buildings_' + str(i) + '.vtu'
    vtu_data =  vtktools.vtu(filename)
    ...
    np.save('/home/dg321/gitTest/PRI/irp/Flow_Data/InterpolatedResult/FpB_Interpolated_t{}_{}_{}_{}'.format(i, field_name, nx, ny), value_grid[0,:,:,0,0])
    ...
    # np.save('buildings_960_960_VelocityAbsorption_remesh', value_remesh)
    ...
    # filename = 'Flow_past_buildings_REMESH_{}'.format(field_name) + str(i) + '.vtu'
    ...
    # print("vtktools.__file__",vtktools.__file__)
    # new_vtu.Write()
