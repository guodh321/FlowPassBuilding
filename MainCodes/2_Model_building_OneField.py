...
num_epochs = 1500  # Adjust the number of training epochs
lr=0.001
batch_size=32
...
torch.save(autoencoder.state_dict(), '/home/dg321/gitTest/PRI/irp/interpolation_code_example_2D/models/Velocity256_Compression_{}epochs_{}batchsize_lr{}_326464.pth'.format(num_epochs, batch_size, lr))  ### Prediction
print("Saved model path: /home/dg321/gitTest/PRI/irp/interpolation_code_example_2D/models/Velocity256_Compression_{}epochs_{}batchsize_lr{}_326464.pth".format(num_epochs, batch_size, lr))
