...
torch.save(autoencoder.state_dict(), '/home/dg321/gitTest/PRI/irp/interpolation_code_example_2D/models/autoencoder_Building_5convsPrediction_0_{}_{}epochs_lr{}fewLayers.pth'.format(size_end_train, num_epochs, lr))  ### Prediction
