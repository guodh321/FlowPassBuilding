...
# comment...
u_cell = np.zeros((ndim,nx,ny,nz,nTime))
u_cell[0,:,:,:,:]=1.0
isotropic=1
dx=ddx[0]
dy=ddx[1]
dz=ddx[2]
print(u2r.mean_diff_calc_nod.__doc__)
print ('inputs:', u_cell.shape, dx, dy, dz, isotropic, nx, ny, nz, ndim, nTime)
#visc, u_mean =u2r.mean_diff_calc_nod(u_cell, ddx, isotropic, nx,ny,nz,ndim,nTime)  
# ...coments
print('back from u_mean')
