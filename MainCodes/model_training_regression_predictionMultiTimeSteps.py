...
torch.save(autoencoder.state_dict(), '/home/dg321/gitTest/PRI/irp/interpolation_code_example_2D/models/autoencoder_Velocity_{}timesteps_{}epochs_lr{}.pth'.format(n_samples, num_epochs, lr))  ### Prediction
